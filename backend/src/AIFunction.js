...
import { searchVideos } from "./searchStockVideo.js";
import { editVideo } from "./editorAI.js";
import axios from "axios";
import fs from 'fs';
import { uploadVideoToS3 } from './s3/s3-module.js';
import ffmpeg from 'fluent-ffmpeg';
import ffprobeStatic from 'ffprobe-static';
import {generateSubtitles} from './generateSubtitles.js'
import { Text } from "./storage.js";
import { processText } from "./createAudio.js";
...
async function generateFullText(headline){
...
async function run(headline) {
    ...
    allParts.caption = subtitleUrl;

    await getAudioDuration(audio)
    .then(duration => allParts.audioSec = duration)
  ...
  `;
    ...
    try{
      ...
      allParts.audio = audio;


      console.log("start edit");

      const finalUrl = await editVideo(allParts);
